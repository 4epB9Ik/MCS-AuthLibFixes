...
public class YggdrasilMinecraftSessionService extends HttpMinecraftSessionService {
    ...
    protected YggdrasilMinecraftSessionService(YggdrasilAuthenticationService authenticationService) {
        ...
        try {
            ...
            System.out.println("SkinFix v1.2 by TaoGunner | Include patches by MCSkill.net");
        } catch (Exception e) {
    ...
    @Override
    public Map<MinecraftProfileTexture.Type, MinecraftProfileTexture> getTextures(final GameProfile profile, boolean requireSecure) {
