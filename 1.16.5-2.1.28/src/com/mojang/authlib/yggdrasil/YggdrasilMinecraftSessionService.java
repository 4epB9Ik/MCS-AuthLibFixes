...
public class YggdrasilMinecraftSessionService extends HttpMinecraftSessionService {
    ...
    private static final URL JOIN_URL = HttpAuthenticationService.constantURL(getBaseUrl() + "/joinserver1122.php");
    private static final URL HAS_JOINED_URL = HttpAuthenticationService.constantURL(getBaseUrl() + "/checkserver1122.php");
    ...
    public GameProfile hasJoinedServer(GameProfile user, String serverId, InetAddress address) throws AuthenticationUnavailableException {
        ...
        URL url = HttpAuthenticationService.concatenateURL(HAS_JOINED_URL, HttpAuthenticationService.buildQuery(arguments));
        try {
